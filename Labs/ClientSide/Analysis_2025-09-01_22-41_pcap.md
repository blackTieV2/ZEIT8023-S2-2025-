...
- `Baseline_ProtocolHierarchy.txt`  
- `Baseline_Endpoints.txt`  
- `AndroidPhone_TCPConversations.txt`  
- `AndroidPhone_UDPConversations.txt`  
- `AndroidPhone_DNSQueries.txt`  
- `AndroidPhone_TopDomains.txt`  
- `AndroidPhone_TLS_SNI.txt`  
- `AndroidPhone_QUIC_SNI.txt`  
- `AndroidPhone_TemporalStats.txt`  
- `Suspicious_DNS_TLDs.txt`  
- `Suspicious_CleartextHTTP.txt`  
